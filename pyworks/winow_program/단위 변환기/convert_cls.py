...
from tkinter import *
#from window_program.단위 변환기.scale_converter import ScaleConverter
from scale_converter import ScaleConverter #윗줄이 안되는 경우 적용
...
app = App(root) # 클래스의 객체 생성 - root를 인자로 생성
